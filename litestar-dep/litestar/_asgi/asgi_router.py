...
class ASGIRouter:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        try:
            ...
            what_is_this = ScopeState.from_scope(scope)
            ScopeState.from_scope(scope).exception_handlers = self._app_exception_handlers

            # FIXME i think this is the last place it reaches before crashing
            # The problem is here... if I add a custom exception handler, it works
